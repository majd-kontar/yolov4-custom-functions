...
def save_model(weights='./data/yolov4.weights', output='./checkpoints/yolov4-416', tiny=False, input_size=416, score_thresh=0.2, framework='tf',
               model='yolov4'):
    ...
    if framework == 'tflite':
        ...
        boxes, pred_conf = filter_boxes(pred_bbox, pred_prob, score_threshold=score_thresh,
