...
def detect(framework='tf', weights='./checkpoints/yolov4-416', size=416, tiny=False, model='yolov4', video='./data/video/video.mp4', output=None,
           output_format='XVID', iou=0.45, score=0.50, count=False, dont_show=False, info=False, ):
    crop = False
    plate = False
    config = ConfigProto()
...
if __name__ == '__main__':
    detect(video='./data/video/3.avi', output='./detections/3.avi')
