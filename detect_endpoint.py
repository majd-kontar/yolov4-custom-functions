...
def detect(framework='tf', weights='./checkpoints/yolov4-416', size=416, tiny=False, model='yolov4', images=['./data/images/kite.jpg'],
           output='./detections/', iou=0.45, score=0.5, dont_show=False, info=False, crop=False):
    oc = False
    plate = False
    count = False
...
if __name__ == '__main__':
    detect(images=['./data/images/car.jpg', './data/images/kite.jpg'])
